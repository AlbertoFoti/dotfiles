...
typedef struct {
  real_T x_dot[6];                     /* '<Root>/x_dot' */
  real_T inVarOut[3];                  /* '<Root>/inVarOut' */
 ...
 *
 * hilite_system('Sim3DOFDetailed/COM3DOF/CoM3DOFDetailed')    - opens subsystem Sim3DOFDetailed/COM3DOF/CoM3DOFDetailed
 * hilite_system('Sim3DOFDetailed/COM3DOF/CoM3DOFDetailed/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'Sim3DOFDetailed/COM3DOF'
 * '<S1>'   : 'Sim3DOFDetailed/COM3DOF/CoM3DOFDetailed'
 * '<S2>'   : 'Sim3DOFDetailed/COM3DOF/CoM3DOFDetailed/MATLAB Function'
 */
