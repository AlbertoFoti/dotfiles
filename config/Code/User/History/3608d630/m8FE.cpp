...
bool MissionScenario::loadScenario(const std::string& scenario_name) {
    ...
    if(!loadConfigFile(scenario_name + "/Control", "InputVariablesControlNSF", [&](const nlohmann::json& jsonData) {
        ...
        this->InputVariablesControl.Jl = jsonData["paramName"]["Jl"];
        this->InputVariablesControl.Jm = jsonData["paramName"]["Jm"];
        this->InputVariablesControl.Jn = jsonData["paramName"]["Jn"];
        this->InputVariablesControl.yaCoM = jsonData["paramName"]["yaCoM"];
        this->InputVariablesControl.xaCoM = jsonData["paramName"]["xaCoM"];
        this->InputVariablesControl.FmaxTh = jsonData["paramName"]["FmaxTh"];
        this->InputVariablesControl.FminTh = jsonData["paramName"]["FminTh"];
        this->InputVariablesControl.FmaxSat = jsonData["paramName"]["FmaxSat"];
        this->InputVariablesControl.FminSat = jsonData["paramName"]["FminSat"];
        this->InputVariablesControl.xIMUb = jsonData["paramName"]["xIMUb"];
        this->InputVariablesControl.yIMUb = jsonData["paramName"]["yIMUb"];
        this->InputVariablesControl.zIMUb = jsonData["paramName"]["zIMUb"];
