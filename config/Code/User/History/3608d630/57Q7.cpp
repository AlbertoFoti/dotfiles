...
bool MissionScenario::loadScenario(const std::string& scenario_name) {
    ...
    if(!loadConfigFile(scenario_name, "PlanetGrav", [&](const nlohmann::json& jsonData) {
        ...
        this->PlanetGrav.paramName = jsonData["SimT"]["Value"]
        this->PlanetGrav.paramName = jsonData["GRAVID"]["Value"]
        this->PlanetGrav.paramName = jsonData["MU"]["Value"]
        this->PlanetGrav.paramName = jsonData["J2"]["Value"]
        this->PlanetGrav.paramName = jsonData["J3"]["Value"]
        this->PlanetGrav.paramName = jsonData["J4"]["Value"]
        this->PlanetGrav.paramName = jsonData["REQ"]["Value"]
