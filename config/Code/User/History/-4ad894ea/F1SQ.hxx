...
#define CoM3DOFDetailed_rtModel        RT_MODEL_CoM3DOFDetailed_T
...
#define rtU                            CoM3DOFDetailed_U
#define ExternalInputs                 ExtU_CoM3DOFDetailed_T
#define rtY                            CoM3DOFDetailed_Y
#define ExternalOutputs                ExtY_CoM3DOFDetailed_T
#define rtP                            CoM3DOFDetailed_P
#define Parameters                     P_CoM3DOFDetailed_T

/* Parameters (default storage) */
struct P_CoM3DOFDetailed_T_ {
  real_T parNom[4];                    /* Variable: parNom
...
extern P_CoM3DOFDetailed_T CoM3DOFDetailed_P;
 ...
 * External functions *
 *====================*/
extern CoM3DOFDetailed_rtModel *CoM3DOFDetailed(void);
