...
coords = {
    "r": 3516200.00,
    "lon": -0.6614798*180/np.pi,
    "lat": 0.3708825*180/np.pi,
    "fpa": -0.2268928*180/np.pi,
    "head": 1.7597*180/np.pi
}
...
target_lat = 0.3169343389*180/np.pi
target_lon = -0.4247084202*180/np.pi
# Convert spherical coordinates to Cartesian coordinates
