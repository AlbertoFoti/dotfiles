...
public:
    ...
    MatrixT(std::vector<std::array<double, 6>> data);
    ...
    void insertRow(std::vector<double> row, size_t ix_row);

    void insertCol(std::vector<double> col, size_t ix_col);
    ...
    static MatrixT matrixSub(MatrixT m1, MatrixT m2);
    ...
    std::vector<double> getRow(uint32_t row);
