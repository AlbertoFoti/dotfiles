...
private:
    ...
    void GetErrSYH(MatrixT xNom0, MatrixT x);
    MatrixT RmCoord(std::vector<double> r, std::vector<double> lon, std::vector<double> lat);
    MatrixT MARS2NEDFunc(std::vector<double> lon, std::vector<double> lat, MatrixT x);
    MatrixT NED2LVFunc(std::vector<double> c, MatrixT x);
};