...
private:
    ...
    double getMuNomAtTime(double t);

    NSFStr randomizeNSFstr(NSFStr inputStr, bool first);
    TimeSeries findOptimalTime();
    std::vector<double> simLinSolDR(std::array<double, 6> x0, std::array<double, 6> xPDP);
};