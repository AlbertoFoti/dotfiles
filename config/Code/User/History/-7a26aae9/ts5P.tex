...
\chapter{Notation and Conventions}
   ...
   \begin{enumerate}
      ...
      \item A \textbf{\textit{North, East, Down (NED) Reference Frame}} is defined, with origin $\mathcal{O}_{NED}$
         ...
         The co-rotating velocity ($v_{m}$), in spherical coordinates on $\mathcal{R}_{NED}$, is the velocity module ($v_{m}$), 
         the flight path angle (FPA, $\gamma$), longitude ($\Lambda$) and latitude ($\lambda$) of the capsule.
