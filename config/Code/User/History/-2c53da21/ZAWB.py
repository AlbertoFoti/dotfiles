...
def rotate(vertices, heading, fpa, bank):
    R_NED = np.array([[np.cos(-np.pi/2), 0, np.sin(-np.pi/2)],
                        [0, 1, 0],
    ...
    R_bank = np.array([[np.cos(bank), -np.sin(bank), 0],
                       [np.sin(bank), np.cos(bank), 0],
                       [0, 0, 1]])
    
    # Combined rotation matrix
    #R = np.dot(R_yaw, np.dot(R_pitch, R_roll))
    R = np.dot(R_NED, np.dot(R_heading, np.dot(R_fpa, R_bank)))
...
class DescentModule:
    ...
    edges = [
        ...
        (4, 12), (5, 11), (6, 10), (7, 9), (13, 3), (14, 2), (15, 1),

        (17, 25), (18, 24), (19, 23), (20, 22), (26, 32), (27, 31), (28, 30),
        (21, 29), (22, 28), (23, 27), (24, 26), (30, 19), (31, 18), (32, 17)
    ]
