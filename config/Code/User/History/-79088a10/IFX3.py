...
while t < 290:
    ...
    dm.updateAttitude(heading[t], fpa[t], zero_bank[t])
    ...
    vel_vectorx = rotate([10, 0, 0], heading[t], fpa[t])
    ax3.quiver(0, 0, 0, vel_vectorx[0], vel_vectorx[1], vel_vectorx[2], color='green')
    vel_vectory = rotate([0, -10, 0], heading[t], fpa[t])
    ax3.quiver(0, 0, 0, vel_vectory[0], vel_vectory[1], vel_vectory[2], color='blue')
    vel_vectorz = rotate([0, 0, -10], heading[t], fpa[t])
    ax3.quiver(0, 0, 0, vel_vectorz[0], vel_vectorz[1], vel_vectorz[2], color='red')
    vel_vector = vel_vectorx + vel_vectory + vel_vectorz
    ax3.quiver(0, 0, 0, vel_vector[0], vel_vector[1], vel_vector[2], color='black')
