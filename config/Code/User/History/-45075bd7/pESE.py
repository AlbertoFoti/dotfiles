...
coords = {
    "r": this->CoMNomX0NSF.xCoMNomEIP[0],
    "lon": this->CoMNomX0NSF.xCoMNomEIP[1],
    "lat": this->CoMNomX0NSF.xCoMNomEIP[2],
    "fpa": this->CoMNomX0NSF.xCoMNomEIP[4],
    "head": this->CoMNomX0NSF.xCoMNomEIP[5]
}
