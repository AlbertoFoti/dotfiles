...
TensorT zeros(std::size_t dim1, std::size_t dim2, std::size_t dim3) {
  TensorT res;

  for(unsigned int i=0; i<dim1; i++) {
    std::vector<std::vector<double>> m = zeros(dim2, dim3);
    res.data.push_back(m);
  }
...
std::vector<double> vectorScalarSub(std::vector<double> v, double alpha) {
  std::vector<double> res {};

  for(unsigned int i=0; i<v.size(); i++) {
    res.push_back(v.at(i) - alpha);
  }
...
std::vector<double> vectorSin(std::vector<double> v) {
  std::vector<double> res {};

  for(unsigned int i=0; i<v.size(); i++) {
    res.push_back(sin(v.at(i)));
  }

  return res;
}

std::vector<double> vectorCos(std::vector<double> v) {
  std::vector<double> res {};

  for(unsigned int i=0; i<v.size(); i++) {
    res.push_back(cos(v.at(i)));
  }

  return res;
}

double vectorScalarProd(std::vector<double> v1, std::vector<double> v2) {
  double res {};
...
std::vector<double> vectorMul(std::vector<double> v1, std::vector<double> v2) {
  std::vector<double> res;
...
std::vector<double> vectorScalarMul(double alpha, std::vector<double> v) {
  std::vector<double> res {};

  for(unsigned int i=0; i<v.size(); i++) {
    res.push_back(alpha*v.at(i));
  }
...
std::vector<double> interp1(std::vector<double> x0, std::vector<double> y0, std::vector<double> xf, const std::string& interp_method) {
  std::vector<double> res;

  return res;
}

MatrixT interp1_matrix(std::vector<double> x0, MatrixT y0, std::vector<double> xf, const std::string& interp_method) {
  MatrixT res;
