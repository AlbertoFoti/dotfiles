...
public:
    ...
    BRMsData(
        ...
        std::vector<std::array<double, 6>> xCoM,
        std::vector<double> tBrInit, 
        std::vector<double> tBrEnd, 
        std::vector<double> dirBr, 
        std::vector<double> brFlag ) 
        : tSim {tSim}, mu {mu}, xCoM {xCoM}, tBrInit {tBrInit}, tBrEnd {tBrEnd}, dirBr {dirBr}, brFlag {brFlag}
    {}
...
public:
    std::vector<double> tSimLast;
    std::vector<TimeSeriesItem> muSimLast;
    // muLastNBR
    std::vector<double> tBrVLast;
    std::vector<double> dirBrLast;
    MatrixT xSimLast;
