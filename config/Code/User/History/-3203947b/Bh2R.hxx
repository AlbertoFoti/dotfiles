...
public:
    ...
    static void title(const std::string& module_name, const std::string& message_format, ...);
    static void done(const std::string& module_name, const std::string& message_format, ...);
