...
bool MissionScenario::loadScenario(const std::string& scenario_name) {
    ...
    // SimEDL X0
    if(!loadConfigFileNSF(scenario_name + "/SimEDL", "SimEDLX0NSF", nlohmann::json& jsonData,
...
bool MissionScenario::loadConfigFileNSF(const std::string& scenario_name, const std::string& str_name, nlohmann::json& jsonData, std::vector<std::string> ids) {
