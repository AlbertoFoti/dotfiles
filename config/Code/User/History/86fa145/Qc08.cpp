...
bool MissionScenario::loadScenario(const std::string& scenario_name) {
    ...
    if(!loadConfigFile(scenario_name + "/SimEDL", "SimEDLParsNSF", [&](const nlohmann::json& jsonData) {
        ...
        NSFStr data;
        data.ids = { "xaCoM", "yaCoM", "zaCoM", "xIMUbSim", "yIMUbSim", "zIMUbSim",
            "mass", "Jxx", "Jyy", "Jzz", "Jxy", "Jxz", "Jyz" 
        };
        data.values = {
                    this->edl.SimEDLParsNSF.xaCoM,
                    this->edl.SimEDLParsNSF.yaCoM,
                    this->edl.SimEDLParsNSF.zaCoM,
                    this->edl.SimEDLParsNSF.xIMUbSim,
                    this->edl.SimEDLParsNSF.yIMUbSim,
                    this->edl.SimEDLParsNSF.zIMUbSim,
                    this->edl.SimEDLParsNSF.mass,
                    this->edl.SimEDLParsNSF.Jxx,
                    this->edl.SimEDLParsNSF.Jyy,
                    this->edl.SimEDLParsNSF.Jzz,
                    this->edl.SimEDLParsNSF.Jxy,
                    this->edl.SimEDLParsNSF.Jxz,
                    this->edl.SimEDLParsNSF.Jyz 
        };
        data.unctype = {
        ...
        this->edl.SimEDLParsNSF.data = data;
    })) {
        return false;
    };
