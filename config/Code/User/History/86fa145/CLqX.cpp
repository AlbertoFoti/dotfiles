...
bool MissionScenario::loadScenario(const std::string& scenario_name) {
    ...
    // SimEDL X0
    if(!loadConfigFileNSF(scenario_name + "/SimEDL", "SimEDLX0NSF", jsonData,
    ...
    // SimEDL X0
    if(!loadConfigFile(scenario_name + "/SimEDL", "SimEDLX0NSF", [&](const nlohmann::json& jsonData) {
        this->edl.SimEDLX0NSF.ids = { "r0Sim", "lon0Sim", "lat0Sim", "vAbs0Sim", "fpa0Sim", "head0Sim",
            "eta0Sim", "aoa0Sim", "mu0Sim", "omgl0Sim", "omgm0Sim", "omgn0Sim" 
        };
        this->edl.SimEDLX0NSF.values = {
            jsonData["r0Sim"]["Value"],
            jsonData["lon0Sim"]["Value"],
            jsonData["lat0Sim"]["Value"],
            jsonData["vAbs0Sim"]["Value"],
            jsonData["fpa0Sim"]["Value"],
            jsonData["head0Sim"]["Value"],
            jsonData["eta0Sim"]["Value"],
            jsonData["aoa0Sim"]["Value"],
            jsonData["mu0Sim"]["Value"],
            jsonData["omgl0Sim"]["Value"],
            jsonData["omgm0Sim"]["Value"],
            jsonData["omgn0Sim"]["Value"],
        };
        this->edl.SimEDLX0NSF.unctype = {
            jsonData["r0Sim"]["Uncertainty Type"],
            jsonData["lon0Sim"]["Uncertainty Type"],
            jsonData["lat0Sim"]["Uncertainty Type"],
            jsonData["vAbs0Sim"]["Uncertainty Type"],
            jsonData["fpa0Sim"]["Uncertainty Type"],
            jsonData["head0Sim"]["Uncertainty Type"],
            jsonData["eta0Sim"]["Uncertainty Type"],
            jsonData["aoa0Sim"]["Uncertainty Type"],
            jsonData["mu0Sim"]["Uncertainty Type"],
            jsonData["omgl0Sim"]["Uncertainty Type"],
            jsonData["omgm0Sim"]["Uncertainty Type"],
            jsonData["omgn0Sim"]["Uncertainty Type"]
        };
        this->edl.SimEDLX0NSF.uncminv = {
            jsonData["r0Sim"]["Std / Min val"],
            jsonData["lon0Sim"]["Std / Min val"],
            jsonData["lat0Sim"]["Std / Min val"],
            jsonData["vAbs0Sim"]["Std / Min val"],
            jsonData["fpa0Sim"]["Std / Min val"],
            jsonData["head0Sim"]["Std / Min val"],
            jsonData["eta0Sim"]["Std / Min val"],
            jsonData["aoa0Sim"]["Std / Min val"],
            jsonData["mu0Sim"]["Std / Min val"],
            jsonData["omgl0Sim"]["Std / Min val"],
            jsonData["omgm0Sim"]["Std / Min val"],
            jsonData["omgn0Sim"]["Std / Min val"]
        };
        this->edl.SimEDLX0NSF.uncmaxv = {
            jsonData["r0Sim"]["Max val"],
            jsonData["lon0Sim"]["Max val"],
            jsonData["lat0Sim"]["Max val"],
            jsonData["vAbs0Sim"]["Max val"],
            jsonData["fpa0Sim"]["Max val"],
            jsonData["head0Sim"]["Max val"],
            jsonData["eta0Sim"]["Max val"],
            jsonData["aoa0Sim"]["Max val"],
            jsonData["mu0Sim"]["Max val"],
            jsonData["omgl0Sim"]["Max val"],
            jsonData["omgm0Sim"]["Max val"],
            jsonData["omgn0Sim"]["Max val"]
        };
    })) {
        return false;
    };
...
bool MissionScenario::loadConfigFileNSF(const std::string& scenario_name, const std::string& str_name, nlohmann::json& jsonData, NSFStr out, std::vector<std::string> ids) {

    this->edl.SimEDLX0NSF.ids = ids;
    this->edl.SimEDLX0NSF.values = {
        jsonData["r0Sim"]["Value"],
        jsonData["lon0Sim"]["Value"],
        jsonData["lat0Sim"]["Value"],
    ...
    og::done("MS", "%s Loading Completed successfully.", str_name.c_str());
    return true;
}
