...
# Texture loading function (replace with your preferred method)
def load_texture(filename):
  texture = SOIL_texture_load(filename, SOIL_LOAD_RGB)
  if not texture:
    raise Exception("Failed to load texture: " + filename)
